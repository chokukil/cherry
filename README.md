...
> 🤖 **Data Science Agent** 채팅 인터페이스

`Cherry AI`는 Model Context Protocol(MCP)을 통해 다양한 외부 도구와 데이터 소스에 접근할 수 있는 ReAct 에이전트를 구현한 프로젝트입니다. 특히 **Data Science Agent**를 제공하여 전문가 수준의 데이터 분석과 머신러닝을 자동화합니다.
